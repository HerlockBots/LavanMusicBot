...
async def play(_, message: Message):
    ...
    try:
        ...
        user.first_name = "LavanMusicVaves"
    usar = user
    wew = usar.id
    try:
    ...
    if audio:
        ...
        [
            [
                InlineKeyboardButton("🔖 Lavan Muzik Support", url=f"https://t.me/LavanderSupport"),
            ],
        ]
    )
        ...
        [
            [
                InlineKeyboardButton("🔖 Lavan Müzik Support", url=f"https://t.me/LavanderSupport"),
            ],
        ]
    )
